...
public class GridHoriAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GridHoriAdapter(Context context, MainMealModel sliderModels, boolean isKitchen) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.grid_holi_adapter, parent, false);
        ...
        if (!isKitchen) {
            ((Holder) holder).itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ActivityDetails.start(context, url, sliderModels.getUrl().get(((Holder) holder).getAdapterPosition()),
                            sliderModels.getName().get(holder.getAdapterPosition()), options.toBundle(), true,false);
                }
            });
        } else {
            ((Holder) holder).itemView.setOnClickListener(new View.OnClickListener() {
